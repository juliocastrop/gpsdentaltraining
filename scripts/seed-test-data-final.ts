/**
 * Seed Test Data Final - With Learning Objectives embedded in description
 * Until the learning_objectives column is added, we embed them in the HTML
 */
...
// Events with Learning Objectives embedded in description HTML
const testEvents = [
  {
...
<ul>
<li>Understand the biology of platelet concentrates and growth factor release kinetics</li>
<li>Master the preparation of A-PRF, L-PRF, and i-PRF using standardized protocols</li>
<li>Apply the sticky bone technique for ridge augmentation and socket preservation</li>
<li>Integrate PRF membranes into extraction and immediate implant procedures</li>
<li>Combine PRF with various bone graft materials for optimal regeneration</li>
</ul>
...
<h3>Learning Objectives</h3>
<ul>
<li>Evaluate patients for implant treatment using proper diagnostic criteria</li>
<li>Interpret CBCT scans for surgical planning and risk assessment</li>
<li>Master flap design and tissue management for implant surgery</li>
<li>Perform basic implant placement in favorable anatomical conditions</li>
<li>Recognize and manage common surgical complications</li>
</ul>

<h3>What's Included</h3>
<ul>
<li>Course manual and surgical guides</li>
<li>Hands-on practice with simulation models</li>
<li>CBCT interpretation workshop</li>
<li>Certificate of completion</li>
<li>Lunch provided both days</li>
</ul>`,
...
async function seedData() {
  ...
  console.log('GPS Dental Training - Test Data Seeder (Final)');
  console.log('With Learning Objectives in Description HTML');
  console.log('='.repeat(60));
  console.log();
  ...
  for (const event of testEvents) {
    ...
    const objectivesMatch = data.description?.match(/<h3>Learning Objectives<\/h3>/i);
    if (objectivesMatch) {
      console.log(`  Learning Objectives: ✓ embedded in description`);
    }
    ...
    if (speakerSlugs) {
      for (let i = 0; i < speakerSlugs.length; i++) {
        ...
        if (speakerId) {
          ...
          console.log(`  Speaker: ${speakerSlugs[i].replace('test-', '')}`);
        }
      }
    }
  ...
  console.log('='.repeat(60));
  console.log('Done! Test the pages at:');
  console.log('');
