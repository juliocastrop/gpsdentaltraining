/**
 * Seed Test Data v2 - Works with existing schema
 */
...
const testSpeakers = [
  {
    ...
    social_links: { linkedin: 'https://linkedin.com/in/josephchoukroun' },
  },
  {
    ...
    social_links: { linkedin: 'https://linkedin.com/in/drcarloscastro' },
  },
  {
...
// Events (using only existing columns)
const testEvents = [
  {
...
<ul>
<li>Understand the biology of platelet concentrates and growth factor release</li>
<li>Master A-PRF, L-PRF, and i-PRF preparation protocols</li>
<li>Apply sticky bone technique for ridge augmentation</li>
<li>Integrate PRF into socket preservation procedures</li>
<li>Optimize PRF membrane application for soft tissue healing</li>
<li>Combine PRF with various bone graft materials</li>
</ul>
...
<li>Access to online resources for 1 year</li>
    ...
    status: 'published',
    schedule_topics: [
      { day: 1, time: '08:00 AM - 08:30 AM', topic: 'Registration & Welcome', description: 'Check-in, materials distribution' },
      { day: 1, time: '08:30 AM - 10:00 AM', topic: 'PRF Biology & Science', description: 'Understanding platelet concentrates and growth factors' },
      { day: 1, time: '10:15 AM - 12:00 PM', topic: 'A-PRF & L-PRF Protocols', description: 'Hands-on preparation of PRF membranes' },
      { day: 1, time: '12:00 PM - 01:00 PM', topic: 'Lunch', description: 'Networking lunch' },
      { day: 1, time: '01:00 PM - 03:00 PM', topic: 'Clinical Applications', description: 'Socket preservation, immediate implant with PRF' },
      { day: 1, time: '03:15 PM - 05:00 PM', topic: 'Sticky Bone Technique', description: 'Ridge augmentation applications' },
      { day: 2, time: '08:00 AM - 10:00 AM', topic: 'i-PRF (Injectable PRF)', description: 'Preparation and applications' },
      { day: 2, time: '10:15 AM - 12:00 PM', topic: 'Live Patient Demo', description: 'Observe PRF-enhanced procedures' },
      { day: 2, time: '01:00 PM - 03:00 PM', topic: 'Sinus Lift Applications', description: 'PRF membranes for sinus augmentation' },
      { day: 2, time: '03:00 PM - 04:30 PM', topic: 'Case Discussion & Q&A', description: 'Complex cases and troubleshooting' },
      { day: 2, time: '04:30 PM - 05:00 PM', topic: 'Certification Ceremony', description: 'Certificate distribution' },
    ],
...
<p>This two-day intensive course is designed for general dentists who want to add implant surgery to their clinical repertoire.</p>

<h3>Learning Objectives</h3>
<ul>
<li>Evaluate patients for implant treatment</li>
<li>Interpret CBCT scans for surgical planning</li>
<li>Master flap design and tissue management</li>
<li>Perform basic implant placement</li>
</ul>`,
    ...
    status: 'published',
    schedule_topics: [
      { day: 1, time: '08:30 AM - 10:00 AM', topic: 'Patient Selection', description: 'Case selection criteria' },
      { day: 1, time: '10:15 AM - 12:00 PM', topic: 'Surgical Anatomy', description: 'Critical anatomical landmarks' },
      { day: 1, time: '01:00 PM - 04:00 PM', topic: 'Hands-On: Basic Placement', description: 'Implant placement on models' },
      { day: 2, time: '08:30 AM - 10:00 AM', topic: 'CBCT Interpretation', description: 'Reading scans' },
      { day: 2, time: '10:15 AM - 12:00 PM', topic: 'Complication Management', description: 'Prevention and management' },
      { day: 2, time: '01:00 PM - 03:00 PM', topic: 'Advanced Cases', description: 'Guided surgery concepts' },
    ],
...
async function seedData() {
  ...
  console.log('GPS Dental Training - Test Data Seeder v2');
  console.log('='.repeat(60));
  console.log();
