      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex gap-3">
            <a
              href={`/courses/${event.slug}${event.status !== 'published' ? '?preview=true' : ''}`}
              target="_blank"
              className="px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 inline-flex items-center gap-2"
            >
